...
type
  bgfx_interface_vtbl* {.bycopy.} = object
    attachment_init*: proc (this: ptr bgfx_attachment_t;
                          ...
                          resolve: uint8)
    vertex_layout_begin*: proc (this: ptr bgfx_vertex_layout_t;
                              rendererType: bgfx_renderer_type_t): ptr bgfx_vertex_layout_t
    vertex_layout_add*: proc (this: ptr bgfx_vertex_layout_t;
                            attrib: bgfx_attrib_t; num: uint8;
                            `type`: bgfx_attrib_type_t; normalized: bool;
                            asInt: bool): ptr bgfx_vertex_layout_t
    vertex_layout_decode*: proc (this: ptr bgfx_vertex_layout_t;
                               attrib: bgfx_attrib_t; num: ptr uint8;
                               `type`: ptr bgfx_attrib_type_t;
                               normalized: ptr bool; asInt: ptr bool)
    vertex_layout_has*: proc (this: ptr bgfx_vertex_layout_t; attrib: bgfx_attrib_t): bool
    vertex_layout_skip*: proc (this: ptr bgfx_vertex_layout_t; num: uint8): ptr bgfx_vertex_layout_t
    vertex_layout_end*: proc (this: ptr bgfx_vertex_layout_t)
    ...
    vertex_unpack*: proc  (output: array[4, cfloat]; attr: bgfx_attrib_t;
                        ...
                        index: uint32)
    vertex_convert*: proc  (dstLayout: ptr bgfx_vertex_layout_t; dstData: pointer;
                         srcLayout: ptr bgfx_vertex_layout_t; srcData: pointer;
                         num: uint32)
    weld_vertices*: proc  (output: pointer; layout: ptr bgfx_vertex_layout_t;
                        data: pointer; num: uint32; index32: bool;
                        epsilon: cfloat): uint32
    ...
    get_supported_renderers*: proc  (max: uint8; rendererEnum: ptr bgfx_renderer_type_t): uint8
    ...
    set_index_buffer_name*: proc  (handle: bgfx_index_buffer_handle_t;
                                name: cstring; len: int32)
    destroy_index_buffer*: proc  (handle: bgfx_index_buffer_handle_t)
    create_vertex_layout*: proc  (layout: ptr bgfx_vertex_layout_t): bgfx_vertex_layout_handle_t
    destroy_vertex_layout*: proc  (layoutHandle: bgfx_vertex_layout_handle_t)
    ...
    get_avail_transient_index_buffer*: proc  (num: uint32; index32: bool): uint32
    get_avail_transient_vertex_buffer*: proc  (num: uint32;
        layout: ptr bgfx_vertex_layout_t): uint32
    ...
    is_texture_valid*: proc  (depth: uint16; cubeMap: bool; numLayers: uint16;
                           format: bgfx_texture_format_t; flags: int64): bool
    is_frame_buffer_valid*: proc  (num: uint8; attachment: ptr bgfx_attachment_t): bool
    calc_texture_size*: proc  (info: ptr bgfx_texture_info_t; width: uint16;
                            ...
                            format: bgfx_texture_format_t)
    create_texture*: proc  (mem: ptr bgfx_memory_t; flags: int64; skip: uint8;
    ...
    create_texture_2d*: proc  (width: uint16; height: uint16; hasMips: bool;
                            ...
                            flags: int64; mem: ptr bgfx_memory_t): bgfx_texture_handle_t
    create_texture_2d_scaled*: proc  (ratio: bgfx_backbuffer_ratio_t;
                                   hasMips: bool; numLayers: uint16;
                                   format: bgfx_texture_format_t;
                                   flags: int64): bgfx_texture_handle_t
    ...
    create_texture_cube*: proc  (size: uint16; hasMips: bool; numLayers: uint16;
                              format: bgfx_texture_format_t; flags: int64;
    ...
    create_frame_buffer*: proc  (width: uint16; height: uint16;
                              format: bgfx_texture_format_t;
                              textureFlags: int64): bgfx_frame_buffer_handle_t
    ...
    set_palette_color_rgba8*: proc  (index: uint8; rgba: uint32)
    ...
    set_view_order*: proc  (id: bgfx_view_id_t; num: uint16;
                         order: ptr bgfx_view_id_t)
    reset_view*: proc  (id: bgfx_view_id_t)
    encoder_begin*: proc  (forThread: bool): ptr bgfx_encoder_t
    encoder_end*: proc  (encoder: ptr bgfx_encoder_t)
    encoder_set_marker*: proc (this: ptr bgfx_encoder_t; marker: cstring)
    encoder_set_state*: proc (this: ptr bgfx_encoder_t; state: int64;
                            rgba: uint32)
    ...
    encoder_set_transient_index_buffer*: proc (this: ptr bgfx_encoder_t;
        ...
        numIndices: uint32)
    encoder_set_vertex_buffer*: proc (this: ptr bgfx_encoder_t; stream: uint8;
                                    handle: bgfx_vertex_buffer_handle_t;
                                    startVertex: uint32; numVertices: uint32)
    encoder_set_vertex_buffer_with_layout*: proc (this: ptr bgfx_encoder_t;
        stream: uint8; handle: bgfx_vertex_buffer_handle_t;
        startVertex: uint32; numVertices: uint32;
    ...
    encoder_set_instance_count*: proc (this: ptr bgfx_encoder_t;
                                     numInstances: uint32)
    encoder_set_texture*: proc (this: ptr bgfx_encoder_t; stage: uint8;
                              sampler: bgfx_uniform_handle_t;
                              handle: bgfx_texture_handle_t; flags: uint32)
    encoder_touch*: proc (this: ptr bgfx_encoder_t; id: bgfx_view_id_t)
    ...
    encoder_set_compute_vertex_buffer*: proc (this: ptr bgfx_encoder_t;
        stage: uint8; handle: bgfx_vertex_buffer_handle_t;
    ...
    encoder_set_compute_indirect_buffer*: proc (this: ptr bgfx_encoder_t;
        stage: uint8; handle: bgfx_indirect_buffer_handle_t;
        access: bgfx_access_t)
    encoder_set_image*: proc (this: ptr bgfx_encoder_t; stage: uint8;
    ...
    encoder_dispatch_indirect*: proc (this: ptr bgfx_encoder_t; id: bgfx_view_id_t;
        ...
        indirectHandle: bgfx_indirect_buffer_handle_t; start: uint16;
                                    num: uint16; flags: uint8)
    encoder_discard*: proc (this: ptr bgfx_encoder_t; flags: uint8)
    ...
    set_vertex_buffer*: proc  (stream: uint8;
                            handle: bgfx_vertex_buffer_handle_t;
                            startVertex: uint32; numVertices: uint32)
    set_vertex_buffer_with_layout*: proc  (stream: uint8;
                                        handle: bgfx_vertex_buffer_handle_t;
                                        startVertex: uint32;
                                        numVertices: uint32; layoutHandle: bgfx_vertex_layout_handle_t)
    set_dynamic_vertex_buffer*: proc  (stream: uint8; handle: bgfx_dynamic_vertex_buffer_handle_t;
                                    startVertex: uint32; numVertices: uint32)
    set_dynamic_vertex_buffer_with_layout*: proc  (stream: uint8;
        handle: bgfx_dynamic_vertex_buffer_handle_t; startVertex: uint32;
        numVertices: uint32; layoutHandle: bgfx_vertex_layout_handle_t)
    set_transient_vertex_buffer*: proc  (stream: uint8;
                                      ...
                                      startVertex: uint32;
                                      numVertices: uint32)
    set_transient_vertex_buffer_with_layout*: proc  (stream: uint8;
        tvb: ptr bgfx_transient_vertex_buffer_t; startVertex: uint32;
        numVertices: uint32; layoutHandle: bgfx_vertex_layout_handle_t)
    set_vertex_count*: proc  (numVertices: uint32)
    ...
    set_instance_data_from_dynamic_vertex_buffer*: proc (
        handle: bgfx_dynamic_vertex_buffer_handle_t; startVertex: uint32;
        num: uint32)
    set_instance_count*: proc  (numInstances: uint32)
    set_texture*: proc  (stage: uint8; sampler: bgfx_uniform_handle_t;
                      handle: bgfx_texture_handle_t; flags: uint32)
    touch*: proc  (id: bgfx_view_id_t)
    ...
    set_compute_indirect_buffer*: proc  (stage: uint8;
                                      ...
                                      access: bgfx_access_t)
    set_image*: proc  (stage: uint8; handle: bgfx_texture_handle_t; mip: uint8;
                    access: bgfx_access_t; format: bgfx_texture_format_t)
    ...
    `discard`*: proc  (flags: uint8)
    blit*: proc  (id: bgfx_view_id_t; dst: bgfx_texture_handle_t; dstMip: uint8;
               dstX: uint16; dstY: uint16; dstZ: uint16;
...
type
  PFN_BGFX_GET_INTERFACE* = proc  (version: uint32): ptr bgfx_interface_vtbl #_t

# proc bgfx_get_interface* (version: uint32): ptr bgfx_interface_vtbl_t